<template>
  <div class="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
      <h2 class="font-semibold text-slate-800 dark:text-slate-100">Horas de capacitación por empleado</h2>
    </header>
    <div class="p-3">
        ...
        <table class="table-auto w-full">
          ...
          <thead class="text-xs font-semibold uppercase dark:text-slate-500 bg-slate-50 dark:bg-slate-700 dark:bg-opacity-50">
            <tr>
              ...
              <th class="p-2 whitespace-nowrap">
                <div class="font-semibold text-left">Horas</div>
              </th>
            </tr>
          </thead>
          <!-- Table body -->
          <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
            ...
            >
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left dark:text-slate-400">{{customer.email}}</div>
              </td>
              <td class="p-2 whitespace-nowrap">
